...
'''We will build a logistic regression classifier to recognize  cats.
AGENDA 
...
'''
Adding _orig at the end of image datasets (train and test) because we are going to preprocess them. 
